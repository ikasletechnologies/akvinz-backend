...
exports.refundSecurityDeposit = refundSecurityDeposit;
exports.refundPlanChangeDeposit = refundPlanChangeDeposit;
...
async function refundOriginalDeposit(customerId, amount, reason) {
    ...
    const originalInvoice = await prisma_1.prisma.invoice.findFirst({
    ...
    return razorpay_1.razorpay.payments.refund(originalInvoice.transactionId, {
...
// its own to do that.
async function refundSecurityDeposit(customerId, amount, reason) {
...
async function refundPlanChangeDeposit(customerId, amount) {
