...
exports.addBillingMonths = addBillingMonths;
exports.getPeriodDays = getPeriodDays;
 ...
 */
function calculateNextBillingDate(fromDate, billingDay, frequency) {
    if (frequency === "DAILY") {
 ...
 */
function addBillingMonths(fromDate, months, billingDay) {
    ...
    return new Date(targetYear, normalizedMonth, day, fromDate.getHours(), fromDate.getMinutes(), fromDate.getSeconds(), fromDate.getMilliseconds());
}
/**
